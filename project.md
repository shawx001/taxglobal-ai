...
- **州覆盖(17 effective)**:CA/NY/OR(累进)、GA/IL/CO(flat/exemption)、**WA(资本利得 excise)**、**NJ(gross-income 累进+门槛+免税额)**、**PA(flat 3.07% gross)**、FL/NV/AK/NH/SD/TN/WY/TX(无税);MA(pending)。
...
## 3. 当前进度 / 下一步
- **刚完成**:Step C1(无税州 AK/NH/SD/TN/WY + 激活 TX)。零引擎改动,纯数据+测试。11→17 effective。
- **州覆盖**:17 effective(CA/NY/OR + GA/IL/CO + WA-excise/NJ/PA + FL/NV/AK/NH/SD/TN/WY/TX);1 pending(MA)。
- **50 州计划**:见 `docs/step_c_all_states_plan.md`。下一批 C2(flat 州: AZ/ID/IN/IA/KY/LA/MI/MS/NC/UT + 激活 MA)→ C3a/C3b(progressive)→ C4(complex)。
