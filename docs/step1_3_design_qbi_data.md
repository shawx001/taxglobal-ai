...
- ✅ Rev. Proc. 2024-40 原文已核对：MFJ 为 $394,600 / $494,600，MFS 为 $197,300 / $247,300，single / HOH / QSS 归入 All Other Returns，为 $197,300 / $247,300。

> 本步只固化 2025 税年 QBI 数据。已归档 IRS QBI 页面描述该扣除适用于 2018 年之后开始、并在 2025-12-31 或之前结束的税年；2025 阈值按 Rev. Proc. 2024-40 适用。
